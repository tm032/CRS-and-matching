...
if __name__ == "__main__":
    ...
    v_1000_optimal_df = v_1000_optimal_df[(v_1000_optimal_df["u_arrival_time"] >= 500) & (v_1000_optimal_df["u_arrival_time"] < 1000) & (v_1000_optimal_df["u_arrival_time"] % 10 == 0)]
    ...
    plt.plot(continuous_df["q"], continuous_df["gamma"], label="Optimal selectability as n → ∞", color='blue')
