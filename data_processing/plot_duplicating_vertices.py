...
with open(project_dir / "raw_results" / "duplicating_vertices_alphas.json", "r") as f:
    alphas = json.load(f)

one_side_u_0 = alphas["one_side_U_0"]
one_side_u_1 = alphas["one_side_U_1"]
one_side_u_half = alphas["one_side_U_half"]
distributed = alphas["distributed"]

# Plot 2x2 subplots for one side duplication and distributed duplication
...
for size_U in range(1, 6):
    ...
    one_side_u_1_alphas = one_side_u_1[str(size_U)]
    one_side_u_half_alphas = one_side_u_half[str(size_U)]
    distributed_alphas = distributed[str(size_U)]
